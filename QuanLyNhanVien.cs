    ...
    class QuanLyNhanVien
    {
        ...
        public void NhapNhanVien()
        {
            ...
            try
            {
                ...
                {
                    case 1:
                        nv.PhongBan = "Phong Nhan Su";
                        break;
                    case 2:
                        nv.PhongBan = "Phong Ke Toan";

                        break;
                    case 3:
                        nv.PhongBan = "Phong Maketing";
     ...
     List<NhanVien> searchResult = new List<NhanVien>();
            List<NhanVien> listNV = DocFile.FileDoc();
            if (id == 1) //Phong Nhan Su
            {
                foreach (NhanVien nv in listNV)
                {
                    if (nv.PhongBan == "Phong Nhan Su")
                        searchResult.Add(nv);

                }
                return searchResult;
            }
            else if (id == 2) //Phong Ke Toan
            {
                foreach (NhanVien nv in listNV)
                {
                    if (nv.PhongBan == "Phong Ke Toan")
                        searchResult.Add(nv);
                }
                return searchResult;
            }
